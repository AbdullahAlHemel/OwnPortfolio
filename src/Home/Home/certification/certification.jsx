...
const Certification = () => {
    ...
    return (<>
        ...
        <div className='flex max-w-6xl m-auto py-8 gap-20 mb-5'>
            <div  data-aos="zoom-in-right"  className='float-right w-1/2 text-center my-auto font-body3 text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-violet-500 '>
            ...
            <p className='font-body4 w-1/2 text-center m-auto leading-4 mt-2 py-1.5'>A Professional Course on web design and development on <span className='text-amber-600'>6 month </span></p>
            ...
            <img data-aos="fade-up"  className='float-left w-2/6 rounded' src={web} alt="" />
        </div>
        </>
    );
};
