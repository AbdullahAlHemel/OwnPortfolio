...
const WhatIDo = () => {
    ...
    return (
        <div>
         ...
         <div className='mx-auto w-[700px] pt-14 pb-5 grid grid-cols-5 '>
           ...
           <div style={{transition:'1s'}} data-aos="flip-left" className='border-amber-200 hover:bg-gradient-to-t from-red-50 to-transparent w-[120px] px-6 py-5 mx-auto font-semibold border rounded-lg shadow-lg shadow-cyan-300 hover:shadow-xl duration-150'><div className=''><img className='' src={SkillIconReact} alt="" /></div></div> 
    ...
    <div className='mx-auto w-[570px] pt-14 pb-5 grid grid-cols-4'>
            ...
            <div style={{transition:'0.5s'}} data-aos="flip-left" className='hover:border-red-200 hover:bg-gradient-to-t from-red-50 to-transparent w-[120px] px-6 py-5 mx-auto font-semibold border rounded-lg shadow-violet-300 shadow-xl duration-150'><div className=''><img className='' src={SkillIconMongo} alt="" /></div></div> 
...
x
    ...
    <div className='mx-auto w-[570px] pt-14 pb-5 grid grid-cols-4'>
            ...
            <div style={{transition:'0.5s'}} data-aos="flip-left" className='hover:border-amber-200 hover:bg-gradient-to-t from-red-50 to-transparent w-[120px] px-6 py-5 mx-auto font-semibold border rounded-lg  shadow-emerald-200 shadow-xl duration-150'><div className=''><img className='' src={Github} alt="" /></div></div> 
