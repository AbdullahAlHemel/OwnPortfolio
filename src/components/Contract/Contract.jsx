...
const Contract = () => {
  ...
  const notify = () => toast("✔️ Message Sent Successfully");
    ...
    <h2 className=' mt-5 text-center font-body2 font-bold text-2xl my-2'>{text}<Cursor cursorColor='blue' /></h2>
  ...
  <form  data-aos="fade-up" data-aos-duration="2000" ref={form} onSubmit={sendEmail} class="w-1/2  bg-base-300 rounded-box p-14">
    ...
    <input onClick={notify} className='border btn' type="submit" name="" id="" value='Send Message' />
  </form> 
