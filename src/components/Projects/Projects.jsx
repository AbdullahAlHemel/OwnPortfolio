...
const Projects = () => {
    ...
    return (<div className='bg-slate-100 py-1 my-8 pb-10'>
            <h2 className=' text-center text-2xl mt-11 font-semibold pb-5 text-emerald-500 font-body2'>Best Projects</h2>
        ...
        <div className='my-6 max-w-4xl m-auto md:flex '>
            <div data-aos="fade-right"  className='bg-white p-8 hover:scale-105 duration-300 flex border-y-2 border-r-2 rounded-r-xl'>
                ...
                <div className='w-1/2 float-right my-auto'>
                    <h2 className='text-center font-semibold text-2xl mt-3 font-body3 pb-5'>News Blog Projects</h2>
        ...
        <div className='my-6 max-w-4xl m-auto md:flex '>
            <div data-aos="fade-left"  className='bg-white p-8 hover:scale-125 duration-300 flex border-y-2 border-l-2 rounded-l-xl'>
                ...
                <div className='w-1/2 float-left my-auto'>
                    <h2 className='text-center font-semibold text-2xl mt-3 font-body3 pb-5'>Car Brand Projects</h2>
                    <div className='text-center mt-5'>
        ...
        <div className='my-6 max-w-4xl m-auto md:flex '>
            <div data-aos="fade-right"  className='bg-white p-8 hover:scale-105 duration-300 flex border-y-2 border-r-2 rounded-r-xl'>
                ...
                <div className='w-1/2 float-right my-auto'>
                    <h2 className='text-center font-semibold text-2xl mt-3 font-body3 pb-5'>Carrier Course Projects</h2>
                    <div className='text-center mt-5'>
